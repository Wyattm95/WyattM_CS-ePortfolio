...
/*
 * The Animal Manager class stores and manages rescue animal records for the Rescue Animal application.
 * This class uses HashMaps to store dog and monkey objects, handles animal intake, reservation, 
 * and printing operations. The class also uses AnimalValidator to validate animal data. 
 */
public class AnimalManager {
    ...
    private String createKey(String animalType, String name) {
        return animalType.toLowerCase() + "-" + name.toLowerCase();
    }
    /*
     ...
     * and adds it to the dog HashMap if the dog is not already in the system.
     */
     ...
     * and adds it to the monkey HashMap if the monkey is not already in the system.
     */
    ...
    /*
     * Reserves an avaialbe dog or monkey based on teh animal type and in-service country.
